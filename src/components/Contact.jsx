...
const Contact = () => {
  ...
  return (
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overfllow-hidden">
      <motion.div
        ...
        >
          <label className="flex flex-col">
            ...
            <input
              ...
              className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounder-lg outlined-none border-none font-medium"
            />
          </label>
          <label className="flex flex-col">
